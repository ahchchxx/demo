...
public class RedisClient {
    ...
    public Object getByKey(String key) {
        ...
        try {
            ...
            client.close(); //jedisPool.returnResourceObject(client);
        }
        return o;
    }
    ...
    public boolean tryGetDistributedLock(String lockKey, String value, int expireTime) {
        Jedis client = jedisPool.getResource();
        try {
            //String result = client.set(lockKey, value, SET_IF_NOT_EXIST, SET_WITH_EXPIRE_TIME, expireTime);
            String result = client.set(lockKey, value, SetParams.setParams().nx().px(expireTime));
